...
class SettingsSeeder extends Seeder
{
    ...
    {
        $tata_tertib = '<ol>
        <li>Siswa hadir 15 menit sebelum ujian dimulai.</li>
        <li>Siswa mengisi daftar hadir sebelum ujian dimulai</li>
        <li>Siswa yang dapat mengikuti ujian adalah Siswa yang telah mengisi daftar hadir</li>
        ...
        <li>Apabila ada kesulitan dan/atau kesalahan teknis dalam proses ujian online, Siswa hanya diperkenankan bertanya pada petugas yang berjaga di ruang ujian</li>
