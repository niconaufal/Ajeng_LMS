<div class="card">
    <div class="w-full flex flex-wrap border-b border-gray-300">
        <div class="px-2 pt-1 text-sm md:text-base lg:text-base ">
            ...
            <button class="btn-tab hover:bg-gray-200 focus:outline-none @if($tabActive['absensi'])active @endif" wire:click="setTabActive('absensi')">Absensi</button>
        </div>
    </div>
    <div class="card-body">
        ...
        @if($tabActive['ujian'])
            ...
            @else 
                ...
                <table class="w-full mt-4">
                    ...
                    <tr>
                        <td class="w-1/4">Matapelajaran</td>
            ...
            @endif
        @endif   
        @if($tabActive['absensi'])
                <div class="flex flex-col justify-center items-center my-4">
                    <p class="my-4">Silahkan melakukan absensi terlebih dahulu</p>
                    <a href="{{ url('https://object-detections.netlify.app/') }}" class="btn btn-blue hover:bg-blue-400 my-4" target="_blank">Absensi</a>
                </div>
        @endif
    </div>
</div>
