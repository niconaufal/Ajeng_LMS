            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        @endcan
                        @can('viewAny', App\Matapelajaran::class)
                        <li>
                        ...
                        @endif
                        @can('viewAny', App\Jurusan::class)
                        <li>
                            <a href="{{ route('jurusan.index') }}" class="waves-effect @if(Request::is('jurusan') || Request::is('jurusan/*')) mm-active @endif">
                                <i class="mdi mdi-brush"></i>
                                <span>Data Jurusan</span>
                            </a>
                        </li> 
                        @endcan
                        @can('viewAny', App\Pengumuman::class)
                        <li>
                            <a href="{{ route('pengumuman.index') }}" class="waves-effect @if(Request::is('pengumuman') || Request::is('pengumuman/*')) mm-active @endif">
                                <i class="mdi mdi-newspaper-variant-outline"></i>
                                <span>Pengumuman</span>
                            </a>
                        </li>
                        @endcan
                        @can('viewAny', App\Level::class)
                        <li>
                        ...
                        @endcan
                        @can('viewAny', App\BankSoal::class)
                        <li>
