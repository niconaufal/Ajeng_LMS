<div class="navbar-header">
    <div class="container-fluid">
        ...
        <div>
            <!-- LOGO -->
            <div class="navbar-brand-box" style="color: white; font-weight: bold;">
                <a href="#" class="logo logo-dark" style="color: white;">
                    <span class="logo-sm">
                        <img src="{{ asset('/images/logo_ajeng.png') }}" alt="" height="30">
                        <span class="font-semibold text-lg tracking-tight ml-2" style="color: white; font-weight: bold;">AJENG LMS</span>
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/images/logo_ajeng.png') }}" alt="" height="40">
                        <span class="font-semibold text-lg tracking-tight ml-2" style="color: white; font-weight: bold;">AJENG LMS</span>
                    </span>
                </a>
