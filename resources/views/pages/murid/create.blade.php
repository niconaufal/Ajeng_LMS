    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Isi form dibawah dengan benar untuk mendaftarkan murid baru</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nisn">Nomor induk siswa nasional (NISN) <small
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nisn">Nomor induk siswa (NIS) <small class="text-danger">*</small></label>
