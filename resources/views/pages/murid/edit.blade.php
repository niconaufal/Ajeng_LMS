    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Edit data murid</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nisn">Nomor induk siswa (NIS)</label>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            {!! Form::number('telp', null, ['class' => 'form-control', 'placeholder' => 'Nomor Handphone', 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Isikan password untuk login</p>
