    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Edit data guru</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nisn">Nomor induk guru nasional <small
                ...
                <div class="form-group">
                    <label for="fotoguru">Foto Guru</label><br>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Kelola matapelajaran yang diajar</p>
                {!! Form::open(['route' => ['gurumapel.remove', $guru->id], 'id' => 'removemapel', 'data-target' => $guru->id]) !!}
                {!! Form::hidden('_method', 'DELETE') !!}
                <div class="d-flex justify-content-between flex-wrap">
                    <div>
                        <p class="text-primary mb-0">List Matapelajaran</p>
                    </div>
                    <div class="mb-2">
                        <a href="#" onclick="showModal(`Apakah anda yakin ingin menghapus matapelajaran untuk {{ $guru->nama }} ?`, `#removemapel`, `{{ $guru->id }}`);" class="btn btn-danger btn-sm">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2">Tidak ada matapelajaran</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                {!! Form::close() !!}
                <p class="text-primary mb-2 mt-4">Tambah Matapelajaran</p>
                <div class="mb-4">
