...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">Pendaftaran Guru Baru</h3>
                <p class="card-title-desc">Isi form dibawah dengan benar untuk mendaftarkan guru baru</p>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {!! Form::text('nama', null, ['class' => 'form-control', 'placeholder' => 'Nama guru', 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nisn">Nomor induk guru nasional <small class="text-danger">Opsional</small></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'Email kamu', 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {!! Form::number('telp', null, ['class' => 'form-control', 'placeholder' => 'Nomor Handphone']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="fotomurid">Foto guru <small class="text-danger">Opsional</small></label>
                        <div>
                            <p>Preview Foto</p>
                ...
                <fieldset>
                    <label for="table-mapel">Pilih Matapelajaran</label>
                    <p>Silahkan pilih matapelajaran yang akan diajar oleh guru ini</p>
