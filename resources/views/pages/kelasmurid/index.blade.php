...
<x-page-title>
    ...
    <x-slot name="item">
        <li class="breadcrumb-item">Kelas Murid</li>
        <li class="breadcrumb-item active">Pilih Murid dan Kelas</li>
    </x-slot>
</x-page-title>
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Pembagian kelas untuk murid yang belum memiliki kelas</p>
